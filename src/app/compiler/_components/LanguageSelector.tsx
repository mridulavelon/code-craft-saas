  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span className="text-gray-200 min-w-[80px] text-left group-hover:text-white transition-colors font-semibold">
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="flex-1 text-left group-hover:text-white transition-colors font-semibold">
                        {lang.label}
                      </span>
